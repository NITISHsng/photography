    ...
    <div className="space-y-8">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center space-x-1 text-green-600">
              <TrendingUp className="h-4 w-4" />
              <span className="text-sm font-medium">
                +{analytics.teamPerformance.growth}%
              </span>
            </div>
          </div>
          <div className="text-3xl font-bold text-gray-800 dark:text-white mb-1">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center space-x-1 text-green-600">
              <TrendingUp className="h-4 w-4" />
              <span className="text-sm font-medium">
                +{analytics.clientSatisfaction.growth}%
              </span>
            </div>
          </div>
          <div className="text-3xl font-bold text-gray-800 dark:text-white mb-1">
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="space-y-4">
            {analytics.teamPerformance.topPerformers.map((performer, index) => (
              <div
                key={index}
                className="flex items-center justify-between p-4 bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 rounded-xl"
              >
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="space-y-4">
            {Object.entries(analytics.clientSatisfaction.breakdown).map(
              ([key, value]) => {
