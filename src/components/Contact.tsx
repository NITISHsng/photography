...
const Contact: React.FC = () => {
  ...
  const handleChange = async (
    ...
    // Optional: warmup call to backend
    try {
  ...
  return (
    <section
      id="contact"
      className="py-6 md:py-8 bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-800 dark:to-gray-900 relative overflow-hidden"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Let us help you tell your story. Contact us today to book a service
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
                  ...
                  through any of these channels, and our team will respond
                  promptly.
                </p>
              </div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between mb-4">
                        <div
                          className={`w-12 h-12 bg-gradient-to-r ${info.color} rounded-lg flex items-center justify-center mb-4`}
                        >
