...
const Hero: React.FC = () => {
  ...
  return (
    <section
      id="home"
      className="pt-20 min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-blue-900 dark:to-purple-900 relative overflow-hidden"
    >
          ...
          <div className="grid md:gap-16 gap-5 items-center">
            <div className="text-center lg:text-left">
              ...
              <div className="mb-0 md:mb-2">
                <p className="text-2xl text-white dark:text-gray-300 mb-2 font-semibold">
